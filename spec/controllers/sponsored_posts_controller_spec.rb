  ...
  context 'GET #edit' do
    ...
    context 'POST create' do
      it 'increased the number of Sponsored Post by 1' do
        expect { post :create, topic_id: topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_number } }.to change(SponsoredPost, :count).by(1)
      end

      it 'assigns the new sponsored_post to @sponsored_post' do
        post :create, topic_id: topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_number }
